...
function sysCall_init()
    ...
    if pluginFound then
        startSub=simROS.subscribe('/sim_control/startSimulation', 'std_msgs/Bool', 'startSimulation_callback')
        pauseSub=simROS.subscribe('/sim_control/pauseSimulation', 'std_msgs/Bool', 'pauseSimulation_callback')
